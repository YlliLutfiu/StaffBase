...
export class EmployeeController {
  ...
  @Get()
  @Get()
  async findAll(@Req() req: any): Promise<EmployeeDTO[]> {
    const userId = req.user.userId;
    const employees = await this.employeeService.findAll(userId);
  ...
  @Post()
  async create(@Body() employeeDTO: EmployeeDTO, @Req() req: any): Promise<EmployeeDTO> {
